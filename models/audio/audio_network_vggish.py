...
from model_zoo.torchvggish import vggish_input, vggish_params
...
cfg.TRAIN.PRETRAINED_VGGISH_MODEL_PATH = "./model_zoo/torchvggish/vggish-10086976.pth"
cfg.TRAIN.PREPROCESS_AUDIO_TO_LOG_MEL = True #! notice
cfg.TRAIN.POSTPROCESS_LOG_MEL_WITH_PCA = False
cfg.TRAIN.PRETRAINED_PCA_PARAMS_PATH = "./model_zoo/torchvggish/vggish_pca_params-970ea276.pth"
